...
namespace yolo
{
Model::Model(const yolo::Config & yolo_config) 
{
    engine_file = yolo_config.engine_file;
    BATCH_SIZE = yolo_config.BATCH_SIZE;
    INPUT_CHANNEL = yolo_config.INPUT_CHANNEL;
    IMAGE_WIDTH = yolo_config.IMAGE_WIDTH;
    IMAGE_HEIGHT = yolo_config.IMAGE_HEIGHT;
    image_order = yolo_config.image_order;
    channel_order = yolo_config.channel_order;
    img_mean = yolo_config.img_mean;
    img_std = yolo_config.img_std;
    alpha = yolo_config.alpha;
    resize = yolo_config.resize;
}
