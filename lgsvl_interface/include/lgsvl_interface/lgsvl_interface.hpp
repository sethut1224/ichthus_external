...
using GEAR_TYPE =
  ...
  std::remove_const<decltype(autoware_auto_vehicle_msgs::msg::GearReport::DRIVE)>::type;
...
private:
  ...
  rclcpp::Publisher<autoware_auto_vehicle_msgs::msg::SteeringReport>::SharedPtr m_steering_report_pub{};
