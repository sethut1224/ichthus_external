...
#ifndef fake_object_publisher__NODE_HPP_
#define fake_object_publisher__NODE_HPP_
...
private:
  ...
  rclcpp::Publisher<autoware_auto_perception_msgs::msg::DetectedObjects>::SharedPtr
    detected_object_autoware_msg_pub_;
  ...
  rclcpp::Subscription<std_msgs::msg::String>::SharedPtr cmd_vel_sub_;
  ...
  void cmdvelCallback(const std_msgs::msg::String::ConstSharedPtr msg);

  std::string key_;

  std::vector<double> move_distance_vec_;
...
#endif  // fake_object_publisher__NODE_HPP_
