...
private:
  ...
  void callbackImuVelocity(const geometry_msgs::msg::TwistStamped::ConstSharedPtr imu_vel_msg_ptr);
  bool getTransform(
  ...
  rclcpp::Subscription<geometry_msgs::msg::TwistStamped>::SharedPtr imu_vel_sub_;
  ...
  rclcpp::Publisher<geometry_msgs::msg::TwistWithCovarianceStamped>::SharedPtr
    imu_twist_with_covariance_pub_;
  ...
  geometry_msgs::msg::TwistStamped::ConstSharedPtr imu_vel_msg_ptr_;
};
