...
#ifndef _ICHTHUS_COMMAND_PANEL_HPP_
#define _ICHTHUS_COMMAND_PANEL_HPP_
...
{
class IchthusCommandPanel : public rviz_common::Panel
{
  Q_OBJECT

public:
  explicit IchthusCommandPanel(QWidget * parent = nullptr);
  void onInitialize() override;

public Q_SLOTS:
  void onClickAutoSetInitialPose();
...
protected:
  ...
  QPushButton *auto_set_initial_pose_button_ptr_;
  ...
  geometry_msgs::msg::PoseWithCovarianceStamped::ConstSharedPtr latest_gnss_pose_cov_;

  void callbackGnssPoseCov(const geometry_msgs::msg::PoseWithCovarianceStamped::ConstSharedPtr msg);
};
