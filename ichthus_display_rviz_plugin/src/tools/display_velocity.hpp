...
#ifndef TOOLS__DISPLAY_VELOCITY_HPP_
#define TOOLS__DISPLAY_VELOCITY_HPP_
...
: public rviz_common::RosTopicDisplay<std_msgs::msg::Float64>
{
  Q_OBJECT

public:
  VelocityDisplay();
  ~VelocityDisplay() override;
...
protected:
  ...
  void processMessage(const std_msgs::msg::Float64::ConstSharedPtr msg_ptr) override;
...
private:
  ...
  std::mutex mutex_;
  std_msgs::msg::Float64::ConstSharedPtr last_msg_ptr_;
};
